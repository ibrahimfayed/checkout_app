      ...
      child: ListView.builder(
        ...
        return Padding(
          ...
          child: GestureDetector(
            onTap: () {
              activeIndex = index;//here activeIndex equals the index of item i pressd according to on tap
            setState(() {});
            },
            child: PaymentItem(
              isActive: activeIndex == index,//here activeIndex equals the index of item i pressd
